#ifndef _STATIC_MATRIX_M_1_HPP_INCLUDED
#define	_STATIC_MATRIX_M_1_HPP_INCLUDED
...
class static_matrix<Type, Row, 1>
:
boost::addable 									<static_matrix<Type, Row, 1>,
boost::addable 									<static_matrix<Type, Row, 1>, Type,
boost::subtractable 							<static_matrix<Type, Row, 1>,
boost::subtractable 							<static_matrix<Type, Row, 1>, Type,
boost::multipliable 							<static_matrix<Type, Row, 1>, Type,
boost::dividable 								<static_matrix<Type, Row, 1>, Type,
boost::equality_comparable 						<static_matrix<Type, Row, 1>,
boost::equality_comparable 						<static_matrix<Type, Row, 1>, Type,
boost::less_than_comparable 					<static_matrix<Type, Row, 1>,
boost::less_than_comparable 					<static_matrix<Type, Row, 1>, Type
> > > > > > > > > >
{
public:
    ...
    typedef static_matrix_buffer<value_type, Row> storage_type;
...
public:
    ...
    template<typename U>
    static_matrix(const static_matrix<U, Row, 1>& rhs)
    {
        operator=<U>(rhs);
    }

    template<typename U>
    self_type & operator=(const static_matrix<U, Row, 1>& rhs)
    {
        do_copy<U>(rhs);
        return *this;
    }
...
private:
    ...
    template<typename U>
    void do_copy(const static_matrix<U, Row, 1>& rhs)
    {
...
public:
    ...
    const static_matrix<value_type, 1, Row>
    operator~() const
    {
        return transpose();
    }
...
public:
    ...
    transpose() const
    {
        static_matrix<value_type, 1, Row> ans;
		copy( begin(), end(), ans.begin() );
...
#endif	/* _STATIC_MATRIX_M_1_HPP_INCLUDED */
