// -*- C++ -*-
/*
 * File:   dynamic_matrix_range_iterator.hpp
 * Author: feng
 *
 */
...
struct dynamic_matrix_range_iterator
{
    public:

        typedef Iterator_Type                           value_type;
        typedef dynamic_matrix_range_iterator           self_type;
    ...
    public:
        ...
        dynamic_matrix_range_iterator(  const value_type& first__,
        ...
        dynamic_matrix_range_iterator( const self_type& other )
